...
function processCommand(cmd) {
    ...
    if (cmd === 'help') {
        ...
        setTimeout(() => window.location.href = "/mimi-sanvalentin/modules/readme.html", 1000);
    } else if (cmd === 'open universes') {
        res.innerHTML = "Accediendo a galería...";
        setTimeout(() => window.location.href = "/mimi-sanvalentin/modules/recuerdos.html", 1000);
    } else if (cmd === 'play music') {
        res.innerHTML = "Iniciando stream...";
        setTimeout(() => window.location.href = "/mimi-sanvalentin/modules/playlist.html", 1000);
    } else if (cmd === 'clear') {
        history.innerHTML = "";
        return;
    } else {
